...
@FXMLController(value = "/fxml/SideMenu.fxml", title = "Material Design Example")
public class SideMenuController {
	...
	public void init() throws FlowException, VetoException {
		...
		bindNodeToController(discovery, DiscoveryController.class, contentFlow, contentFlowHandler);
